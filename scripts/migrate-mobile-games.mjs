// scripts/migrate-mobile-games.mjs
...
const sql = readFileSync(
  path.join(__dirname, "../supabase/migrations/20260316000000_create_mobile_games.sql"),
  "utf8"
);
...
if (error) {
  ...
  console.log("✅ mobile_games migration applied.");
}
